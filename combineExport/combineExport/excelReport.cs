...
{
    public partial class excelReport : Form
    {
        ...
        {
            pivotRangeSetting pSetting = new pivotRangeSetting();
            pSetting.ShowDialog();
        }

        private void 컬럼설정ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            excelSetting exSetting = new excelSetting();
            exSetting.ShowDialog();
        }
    }
}
